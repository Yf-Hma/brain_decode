...
import os
import torch
from load_data import data_builder_v0, data_builder
from src.models import MllmBrainToTextV0
...
def train (model, model_name, data_loader, rank, epochs = 100, save_epochs = 10, starting_epoch = 1):
    ...
    for epoch in range(starting_epoch, epochs + 1):
        ...
        if epoch % save_epochs == 0:    
            if rank == 0:
                ...
                save_checkpoint(model.module, model_name, epoch)
